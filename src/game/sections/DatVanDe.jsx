export default function DatVanDe() {
  const elements = [
    { n: '01', t: 'Bản Chất Giai Cấp Công Nhân', s: 'Nhà nước do Đảng Cộng sản lãnh đạo, định hướng XHCN, vận hành theo tập trung dân chủ. Bản chất này thống nhất sâu sắc với tính nhân dân và dân tộc.' },
    { n: '02', t: 'Nhà Nước Của Dân', s: 'Tất cả quyền lực đều thuộc về nhân dân. Nhân dân là người chủ tối cao của đất nước, thực thi quyền lực thông qua hình thức dân chủ trực tiếp và gián tiếp.' },
    { n: '03', t: 'Nhà Nước Do Dân', s: 'Nhà nước do nhân dân lập nên qua bầu cử, do dân đóng thuế để chi tiêu và do dân giám sát. Dân có quyền bãi miễn những đại biểu không xứng đáng.' },
    { n: '04', t: 'Nhà Nước Vì Dân', s: 'Mọi đường lối, chính sách đều nhằm phục vụ lợi ích chính đáng của nhân dân. "Việc gì có lợi cho dân, ta phải hết sức làm", không có đặc quyền đặc lợi.' },
  ];
  const practices = [
    { n: '01', t: 'Sự lãnh đạo của Đảng', s: 'Đảng đề ra đường lối, chủ trương để Nhà nước thể chế hóa thành pháp luật, đảm bảo định hướng phát triển vì nhân dân.' },
    { n: '02', t: 'Quyền lực tối cao của Dân', s: 'Dân bầu ra bộ máy công quyền, có quyền kiểm soát, phê bình và bãi miễn đại biểu. Quyền lực nhà nước là do dân ủy thác.' },
    { n: '03', t: 'Năng lực làm chủ', s: 'Hồ Chí Minh nhấn mạnh "Muốn làm chủ tốt phải có năng lực làm chủ" – Nhà nước có trách nhiệm giáo dục và nâng cao dân trí.' },
    { n: '04', t: 'Vị thế "Công bộc" cán bộ', s: 'Cán bộ từ cấp cao nhất đến nhân viên đều là "đầy tớ" của nhân dân, không phải "quan cách mạng", phải "lo trước thiên hạ, vui sau thiên hạ".' }
  ];
    ...
    <section id="dat-van-de" className="relative w-full bg-[#EDE8E1] px-4 py-32 md:py-40 overflow-hidden">
      ...
      <div className="w-full max-w-7xl mx-auto mb-24 md:mb-32">
        ...
        <p className="gsap-reveal text-lg text-[#7A6040] max-w-2xl leading-relaxed font-light" style={{ fontFamily: f2 }}>
          Theo Giáo trình Tư tưởng Hồ Chí Minh, học thuyết của Người về Nhà nước dân chủ được xây dựng trên 4 đặc trưng (trụ cột) cốt lõi: mang bản chất giai cấp công nhân, và là một Nhà nước của nhân dân, do nhân dân, vì nhân dân.
        </p>
      </div>

      {/* 4 Core Elements — Progressive Stagger */}
      <div className="w-full max-w-7xl mx-auto gsap-stagger-parent grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-32">
        {elements.map((item) => (
      ...
      <div className="w-full max-w-7xl mx-auto mb-32">
        ...
        <div className="gsap-stagger-parent grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          {practices.map((item) => (
            <div key={item.n} className="gsap-stagger-child card-tilt group">
